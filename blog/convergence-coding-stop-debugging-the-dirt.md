...
![Stop Debugging the Dirt](https://github.com/jade-pico/antrieb/blob/main/images/debugging-the-dirt.png)
...
**Convergence coding is the loop of generating an infrastructure hypothesis, testing it against reality (conformance, completeness, compliance), and refining it until the system matches intent.**
